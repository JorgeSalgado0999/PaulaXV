 ...
 */
export default (taco, Components, name) => {
	/**
	...
	function updateDisabled() {
		...
		const isEnough = taco.length > taco.options.perPage || taco.is(LOOP);
	...
	function appendArrows() {
		...
		const parent = taco.options.arrows === "slider" && slider ? slider : root;
